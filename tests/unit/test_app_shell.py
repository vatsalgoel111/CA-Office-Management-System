...
class AppShellTest(unittest.TestCase):
    ...
    def test_app_shell_navigation_items_include_permission_codes(self) -> None:
        ...
        self.assertEqual(
            items["staff"].required_permission,
        ...
        self.assertEqual(
            items["collections"].required_permission,
        ...
        self.assertEqual(
            items["audit"].required_permission,
        ...
        self.assertEqual(
            items["notifications"].required_permission,
        ...
        self.assertEqual(
            items["reminders"].required_permission,
            (
                PermissionCode.WORK_VIEW_ALL.value,
                PermissionCode.WORK_VIEW_ASSIGNED.value,
            ),
